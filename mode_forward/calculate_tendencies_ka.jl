include("../mode_init/MPAS_Ocean_ka.jl")

######## KernelAbstractions tendency calculation methods

function calculate_normal_velocity_tendency_ka!(mpasOcean::MPAS_Ocean)
    #    CUDA.@cuda blocks=cld(mpasOcean.nEdges, 1024) threads=1024 maxregs=64 calculate_normal_velocity_tendency_ka_kernel!(
    calculate_normal_velocity_tendency_ka_kernel!(mpasOcean.backend)(mpasOcean.nEdges,
...
@kernel function calculate_normal_velocity_tendency_ka_kernel!(nEdges,
...
function update_normal_velocity_by_tendency_ka!(mpasOcean::MPAS_Ocean)
    #CUDA.@cuda blocks=cld(mpasOcean.nEdges, 1024) threads=1024 maxregs=64 update_normal_velocity_by_tendency_ka_kernel!(
    update_normal_velocity_by_tendency_ka_kernel!(mpasOcean.backend)(mpasOcean.nEdges,
                                                    mpasOcean.normalVelocityCurrent,
                                                    mpasOcean.dt,
                                                    mpasOcean.normalVelocityTendency,
                                                    mpasOcean.maxLevelEdgeTop;
...
@kernel function update_normal_velocity_by_tendency_ka_kernel!(nEdges,
...
function calculate_thickness_tendency_ka!(mpasOcean::MPAS_Ocean)
    #CUDA.@cuda blocks=cld(mpasOcean.nCells, 1024) threads=1024 maxregs=64 calculate_thickness_tendency_ka_kernel!(
    calculate_thickness_tendency_ka_kernel!(mpasOcean.backend)(mpasOcean.nCells,
...
@kernel function calculate_thickness_tendency_ka_kernel!(nCells,
...
function update_thickness_by_tendency_ka!(mpasOcean::MPAS_Ocean)
    #CUDA.@cuda blocks=cld(mpasOcean.nCells, 1024) threads=1024 maxregs=64 update_thickness_by_tendency_ka_kernel(
    update_thickness_by_tendency_ka_kernel!(mpasOcean.backend)(
...
@kernel function update_thickness_by_tendency_ka_kernel!(nCells,
                                             layerThickness,
                                             dt,
                                             layerThicknessTendency,
                                             maxLevelCell)
